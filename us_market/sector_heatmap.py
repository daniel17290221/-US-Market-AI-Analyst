...
class SectorHeatmapCollector:
    ...
    def __init__(self):
        ...
        self.sector_stocks = {
             ...
             'Healthcare': ['LLY', 'UNH', 'JNJ', 'ABBV', 'MRK', 'TMO', 'ABT', 'DHR'],
             'Energy': ['XOM', 'CVX', 'COP', 'SLB', 'EOG', 'MPC', 'PSX', 'VLO'],
             'Consumer Disc.': ['AMZN', 'TSLA', 'HD', 'MCD', 'NKE', 'LOW', 'SBUX', 'TJX'],
             'Consumer Staples': ['WMT', 'PG', 'COST', 'KO', 'PEP', 'PM', 'MDLZ', 'MO'],
             'Industrials': ['CAT', 'GE', 'RTX', 'HON', 'UNP', 'BA', 'DE', 'UPS'],
             'Materials': ['LIN', 'APD', 'SHW', 'FCX', 'ECL', 'NEM', 'NUE', 'DOW'],
             'Utilities': ['NEE', 'SO', 'DUK', 'CEG', 'SRE', 'AEP', 'D', 'PCG'],
             'Real Estate': ['PLD', 'AMT', 'EQIX', 'SPG', 'PSA', 'O', 'WELL', 'DLR'],
             'Comm. Services': ['META', 'GOOGL', 'GOOG', 'NFLX', 'DIS', 'T', 'VZ', 'CMCSA'],
        }
